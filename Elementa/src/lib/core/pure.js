...
const ELEMENT_DETAILS = {
  earth: {
    ...
    description:
      "The cube is the most stable of the Platonic solids, echoing the steady heartbeat of soil and stone.",
    natureAction:
      "Press your bare feet into soil or hold a smooth stone and study its details for 30 seconds.",
    quickFacts: [
  ...
  water: {
    ...
    figure: "Icosahedron",
    description:
      "Twenty triangular faces mirror endless ripples—each angle a new current or emotional tide.",
    natureAction:
      "Cup water in your hands and feel its movement, or listen closely to running water for a minute.",
    quickFacts: [
  ...
  fire: {
    ...
    figure: "Tetrahedron",
    description:
      "Four faces rise into a single point, channeling breath upward like sparks leaping from flame.",
    natureAction:
      "Warm your palms near a flame or sunlight and notice the heat before journaling.",
    quickFacts: [
  ...
  air: {
    ...
    figure: "Octahedron",
    description:
      "Twin pyramids join at the center, symbolizing balance between inhale and exhale, thought and expression.",
    natureAction:
      "Step outside, touch a tree if possible, and take three long, intentional breaths.",
    quickFacts: [
  ...
  spirit: {
    ...
    figure: "Dodecahedron",
    description:
      "Twelve pentagons orbit a hidden center, hinting at the unseen layers that bind each element together.",
    natureAction:
      "Find a quiet view of the sky, close your eyes briefly, and notice any whispers of intuition.",
    quickFacts: [
 ...
 */
export const getNatureAction = (element) =>
  ELEMENT_DETAILS[element]?.natureAction || "";
